...
# 2. git remote add origin git@github.com:yAvataRy/landing-social-media-curso.git
...
# -> fatal: repository 'https://github.com/yAvataRy/landing-social-media-curso.git/' not found
#
# ✅ Solução:
# -> Use a URL SSH corretamente com:
#    git remote set-url origin git@github.com:yAvataRy/landing-social-media-curso.git
# -> Ou adicione o origin certo:
#    git remote add origin git@github.com:yAvataRy/landing-social-media-curso.git
#
